...
wwd_result_t host_rtos_create_thread(
	...
	void (*entry_function)(wwd_thread_arg_t arg), const char *name,
	/*@null@ */ void *stack,
...
wwd_result_t host_rtos_create_thread_with_arg(
	...
	void (*entry_function)(wwd_thread_arg_t arg), const char *name,
	/*@null@ */ void *stack,
	uint32_t stack_size, uint32_t priority, wwd_thread_arg_t arg)
{
	wwd_result_t result;
...
wwd_result_t host_rtos_create_configed_thread(
	/*@out@ */ host_thread_type_t *thread,
	void (*entry_function)(uint32_t), const char *name,
	/*@null@ */ void *stack,
	uint32_t stack_size, uint32_t priority, host_rtos_thread_config_type_t *config)
{
